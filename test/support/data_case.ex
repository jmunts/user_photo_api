defmodule UserPhotoAPI.DataCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import UserPhotoAPI.DataCase
    end
  end

  setup tags do
    :ok = Ecto.Adapters.SQL.Sandbox.checkout(UserPhotoAPI.Repo)

    unless tags[:async] do
      Ecto.Adapters.SQL.Sandbox.mode(UserPhotoAPI.Repo, {:shared, self()})
    end
